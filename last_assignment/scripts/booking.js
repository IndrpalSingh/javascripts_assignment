...
{
    if 
 (tuesdayBtn.classList.contains('clicked')) {
...
wednesdayBtn.addEventListener('click', function () {
    if (wednesdayBtn.classList.contains('clicked')) {
        wednesdayBtn.classList.contains('clicked');
...
thursdayBtn.addEventListener('click', function () {
    if 
    (thursdayBtn.classList.contains('clicked')) {
    ...
    if (fridayBtn.classList.contains('clicked'))
{
    ...
    friendayBtn.classList.add('clicked');
    dailyRate = 'full' ;
...
clearBtn.addEventListener('click', function () {
    ...
    tuesdayBtn.classList.remove('clicked');
    mondaysBtn.classList.remove('clicked');
    listDays = [];
    calculateCost ();
